...
blog_small = ['0a421343005f3241376fa01e1cb3c6fb','0ba982819aaf9f5b94a7cebd48ac6018','0c49bb860962aa0d5b8e3fc277592da0','0cfdfe102b7a4cb34e1a181c1d36d23d']

def index_list():
	list_of_lists = []
	list_of_ylabels = []
	list_of_pairs = []
	for x in blog_small:#blog_ids:
	#x = blog_ids[0]	
		lists = []
		pairlist = []
		ylabel = []
...
def main():
	...
	train_x,train_y_pairs,train_y_labels = index_list()
	print train_x
	print "*****"
	print train_y_pairs
	print "*****"
