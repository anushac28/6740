...
class SentimentModel(object):
	...
	learning_rate, lr_decay,batch_size, forward_only=False):
		...
		#SCOPE ???
			...
			def body(i,tf_assign,rnn_state,W1,b1,W2,b2): 
				print "BODY ****"
			...
			def cond(i,pair_rep,rnn_state,W1,b1,W2,b2):
			...
			tf.while_loop(cond, body , [i,tf_assign,rnn_state,W1,b1,W2,b2])

			pair_rep = tf.pack(tf_assign)
